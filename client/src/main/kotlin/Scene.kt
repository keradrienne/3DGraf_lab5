...
class Scene (
  ...
  val skeletonTexture = DataTexture(gl, Uint32Array(animation.skeleton.buffer),
    zombieGeom.nBones, 1, GL.RGBA32UI, GL.RGBA_INTEGER, GL.UNSIGNED_INT)
